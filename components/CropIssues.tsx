            ...
            >
              <View style={[tailwind`mt-0`]}>
                {issuesByCrop?.length ? (
                  ...
                  >
                    <View
                      style={tailwind`flex flex-row justify-between -mb-6 items-center`}
                    >
                      <Text
                        style={tailwind`text-3xl pb-4 text-green-900 text-center max-w-[85] mx-auto mt-20`}
                      >
                        No se encontraron {issueTitle} para {crop.title}
                      </Text>
                    </View>
