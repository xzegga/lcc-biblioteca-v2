        ...
        {({ pressed }) => (
          ...
          >
            ...
            <View style={tailwind`pr-2 flex-1`}>
              <Text
                style={tailwind`text-xl font-normal text-slate-600 px-1.5 pb-1`}
              >
                {crop.title}
              </Text>
              <Text
                style={tailwind`text-sm font-normal text-slate-400 px-1.5 pb-1`}
              >
                {crop.scientific_name}{" "}
              </Text>
              <Text
                style={tailwind`text-base font-normal leading-6 text-slate-600 px-1.5 pb-1`}
              >
                {shortenText(crop.description, 60)}
              </Text>
            </View>
          </View>
        )}
