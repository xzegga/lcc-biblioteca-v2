...
import Animated, { FadeInDown, SlideInDown, useAnimatedStyle, useSharedValue, withSpring } from 'react-native-reanimated';
...
export default function TabBarIcon({ image, color, focused }: TabProps) {
    ...
    return <Animated.Image entering={FadeInDown}
